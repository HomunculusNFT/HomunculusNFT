...
import '../main.css';
import DemoNFT from '../images/Demo.png';
        ...
        <div style={{
            ...
            <div className="FlexBoxes">
                <div style={{ margin: '1vw', height: '25vw' }}>
                    ...
                    <div>
                        < button className="DisabledButton" style={{ width: '25vw', height: '5vw', fontSize: '1.5vw', padding: '1vw 1vw', alignSelf: 'right' }}> 3088/3088</button>
                    </div>
                </div>
                <div style={{ width: '25vw', height: '25vw' }}>
                    ...
                    < button className="DisabledButton" style={{ width: '25vw', height: '5vw', fontSize: '1.5vw', padding: '1vw 1vw', alignSelf: 'right' }}>Burnt Out!</button>
                </div>
            </div>
        </div >
